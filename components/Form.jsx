    ...
    <form onSubmit={handleSubmit} className='mx-10'>
      <div className='bg-blue-gradient w-full h-full rounded-md p-0.5 mt-10 relative'>
        ...
        <div className='bg-black rounded-md text-white grid grid-rows-7 place-items-center p-[30px]' >
          ...
          <div>
            <input type="text" id="name" value={name} placeholder='Name your NFT' onChange={handleNameChange} required className='bg-gray-800 text-gray-300 placeholder-gray-500 border-gray-600 focus:ring-gray-400 focus:border-gray-400 rounded-md py-2 px-4 font-poppins w-[30vw]' />
          </div>
          <div className='flex mt-10 mb-2'>
            <label htmlFor="description" className='font-poppins text-[28px]'>Description:</label>
          </div>
          <div>
            <textarea id="description" value={description} onChange={handleDescriptionChange} className='bg-gray-800 text-gray-300 placeholder-gray-500 border-gray-600 focus:ring-gray-400 focus:border-gray-400 rounded-md py-2 px-4 font-poppins w-[30vw]' placeholder='Provide a detailed description of your NFT.' />
          </div>
